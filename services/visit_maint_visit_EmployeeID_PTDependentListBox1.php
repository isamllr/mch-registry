<?php
//Include Common Files @1-80A274ED
define("RelativePath", "..");
define("PathToCurrentPage", "/services/");
define("FileName", "visit_maint_visit_EmployeeID_PTDependentListBox1.php");
...
//Show Method @2-6BC19C2E
    function Show()
    {
        ...
        $this->DataSource->Parameters["expr583"] = "1";
...
//Prepare Method @2-4739B3A0
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "expr583", ccsInteger, "", "", $this->Parameters["expr583"], "", false);
        $this->wp->AddParameter("2", "urlkeyword", ccsInteger, "", "", $this->Parameters["urlkeyword"], "", true);
        $this->wp->Criterion[1] = $this->wp->Operation(opEqual, "position.PositionID", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsInteger),false);
        $this->wp->Criterion[2] = $this->wp->Operation(opEqual, "location.FacilityID", $this->wp->GetDBValue("2"), $this->ToSQL($this->wp->GetDBValue("2"), ccsInteger),true);
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "visit_maint_visit_EmployeeID_PTDependentListBox1.html";
$BlockToParse = "main";
...
//Initialize HTML Template @1-6E7753F9
