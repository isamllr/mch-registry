<?php
//Include Common Files @1-846BB922
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "report_complications_after_delivery.php");
...
//Operation Method @45-EFE0C2F9
    function Operation()
    {
        ...
        $Redirect = "report_complications_after_delivery.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "report_complications_after_delivery.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//Open Method @33-9D9FD17E
    function Open()
    {
        ...
        "FROM (pcomplications INNER JOIN delivery ON\n\n" .
        "pcomplications.DeliveryID = delivery.DeliveryID) INNER JOIN icd10_all ON\n\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "report_complications_after_delivery.html";
$BlockToParse = "main";
...
//Include events file @1-CD74496B
include_once("./report_complications_after_delivery_events.php");
...
$Report_Print->Page = "report_complications_after_delivery.php";
