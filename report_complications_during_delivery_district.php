<?php
//Include Common Files @1-DF9175A4
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "report_complications_during_delivery_district.php");
...
//Operation Method @45-EE33F3E1
    function Operation()
    {
        ...
        $Redirect = "report_complications_during_delivery_district.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "report_complications_during_delivery_district.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//Open Method @33-7953CC99
    function Open()
    {
        ...
        "FROM ((delivery INNER JOIN complications ON\n\n" .
        "complications.DeliveryID = delivery.DeliveryID) INNER JOIN facilities ON\n\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "report_complications_during_delivery_district.html";
$BlockToParse = "main";
...
//Include events file @1-974DF54B
include_once("./report_complications_during_delivery_district_events.php");
