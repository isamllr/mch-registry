<?php
//Include Common Files @1-90709CA5
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "report_complications_after_delivery_district.php");
...
//Class_Initialize Event @45-2137C519
...
//CheckErrors Method @45-4878E8BC
...
//Operation Method @45-D5888E9C
    function Operation()
    {
        ...
        $Redirect = "report_complications_after_delivery_district.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "report_complications_after_delivery_district.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//Open Method @33-F4F00506
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT icd10_all.ICD10ID AS icd10_all_ICD10ID, delivery.DeliveryID AS delivery_DeliveryID, DiseaseName, FacilityName \n\n" .
        "FROM ((delivery INNER JOIN pcomplications ON\n\n" .
        "pcomplications.DeliveryID = delivery.DeliveryID) INNER JOIN facilities ON\n\n" .
        "delivery.FacilityID = facilities.FacilityID) INNER JOIN icd10_all ON\n\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "report_complications_after_delivery_district.html";
$BlockToParse = "main";
...
//Include events file @1-EB7680BF
include_once("./report_complications_after_delivery_district_events.php");
...
$Report_Print->Page = "report_complications_after_delivery_district.php";
