<Page id="1" templateExtension="html" relativePath="." fullRelativePath="." secured="True" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="{CCS_Style}" wizardThemeVersion="3.0" needGeneration="0" pasteActions="pasteActions" accessDeniedPage="noaccess.ccp">
	<Components>
		...
		<Report id="33" secured="False" enablePrint="True" showMode="Web" sourceType="Table" returnValueType="Number" linesPerWebPage="40" linesPerPhysicalPage="50" name="delivery_pcomplications_i1" connection="registry_db" dataSource="delivery, icd10_all, complications, facilities" pageSizeLimit="100" activeCollection="TableParameters">
			<Components>
			...
			<Events/>
			<TableParameters>
				<TableParameter id="44" conditionType="Parameter" useIsNull="False" field="delivery.DataDelivery" dataType="Date" searchConditionType="NotNull" parameterType="URL" parameterSource="DataDelivery" format="ShortDate" DBFormat="yyyy-mm-dd HH:nn:ss" logicOperator="And" leftBrackets="0" rightBrackets="0"/>
				<TableParameter id="66" conditionType="Parameter" useIsNull="False" field="icd10_all.ICD10ID" dataType="Text" searchConditionType="GreaterThanOrEqual" parameterType="URL" logicOperator="And" orderNumber="1" parameterSource="s_icd10_all_ICD10ID1" leftBrackets="0" rightBrackets="0"/>
				<TableParameter id="83" conditionType="Parameter" useIsNull="False" field="icd10_all.ICD10ID" dataType="Text" searchConditionType="LessThanOrEqual" parameterType="URL" parameterSource="s_icd10_all_ICD10ID2" logicOperator="And" leftBrackets="0" rightBrackets="0"/>
				<TableParameter id="75" conditionType="Parameter" useIsNull="False" field="delivery.DataDelivery" dataType="Date" searchConditionType="GreaterThanOrEqual" parameterType="URL" parameterSource="s_DataDelivery" format="ShortDate" DBFormat="yyyy-mm-dd HH:nn:ss" logicOperator="And" leftBrackets="0" rightBrackets="0"/>
				<TableParameter id="76" conditionType="Parameter" useIsNull="False" field="delivery.DataDelivery" dataType="Date" searchConditionType="LessThanOrEqual" parameterType="URL" parameterSource="s_DataDelivery1" format="ShortDate" DBFormat="yyyy-mm-dd HH:nn:ss" logicOperator="And" leftBrackets="0" rightBrackets="0"/>
				<TableParameter id="98" conditionType="Parameter" useIsNull="False" field="facilities.FacilityName" dataType="Text" searchConditionType="Contains" parameterType="URL" logicOperator="And" parameterSource="s_FacilityName"/>
			</TableParameters>
			<JoinTables>
				...
				<JoinTable id="89" tableName="complications" posLeft="194" posTop="24" posWidth="106" posHeight="104"/>
				<JoinTable id="94" tableName="facilities" posLeft="287" posTop="207" posWidth="95" posHeight="104"/>
			</JoinTables>
			<JoinLinks>
				<JoinTable2 id="90" tableLeft="complications" tableRight="delivery" fieldLeft="complications.DeliveryID" fieldRight="delivery.DeliveryID" joinType="inner" conditionType="Equal"/>
				<JoinTable2 id="91" tableLeft="complications" tableRight="icd10_all" fieldLeft="complications.ICD10ID" fieldRight="icd10_all.ICD10ID" joinType="inner" conditionType="Equal"/>
				<JoinTable2 id="95" tableLeft="delivery" tableRight="facilities" fieldLeft="delivery.FacilityID" fieldRight="facilities.FacilityID" joinType="inner" conditionType="Equal"/>
			</JoinLinks>
			<Fields>
				...
				<Field id="97" tableName="facilities" fieldName="FacilityName"/>
			</Fields>
			<SPParameters/>
			<SQLParameters/>
			<ReportGroups>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="report_complications_during_delivery_district_events.php" forShow="False" comment="//" codePage="utf-8"/>
		<CodeFile id="Code" language="PHPTemplates" name="report_complications_during_delivery_district.php" forShow="True" url="report_complications_during_delivery_district.php" comment="//" codePage="utf-8"/>
	</CodeFiles>
	<SecurityGroups>
		<Group id="92" groupID="1"/>
		<Group id="93" groupID="2"/>
	</SecurityGroups>
	<CachingParameters/>
	<Attributes/>
	<Features/>
