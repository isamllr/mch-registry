<Page id="1" templateExtension="html" relativePath="." fullRelativePath="." secured="True" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="{CCS_Style}" wizardThemeVersion="3.0" needGeneration="0" pasteActions="pasteActions" accessDeniedPage="noaccess.ccp">
	<Components>
		...
		<Report id="33" secured="False" enablePrint="True" showMode="Web" sourceType="Table" returnValueType="Number" linesPerWebPage="40" linesPerPhysicalPage="50" name="delivery_pcomplications_i1" connection="registry_db" dataSource="delivery, pcomplications, icd10_all" pageSizeLimit="100" activeCollection="TableParameters">
			<Components>
			...
			<TableParameters>
				...
				<TableParameter id="85" conditionType="Parameter" useIsNull="False" field="delivery.FacilityID" dataType="Integer" searchConditionType="In" parameterType="Session" parameterSource="s_Facilities" format="0;(0)" logicOperator="And" defaultValue="0"/>
			</TableParameters>
			<JoinTables>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="report_complications_after_delivery_events.php" forShow="False" comment="//" codePage="utf-8"/>
		<CodeFile id="Code" language="PHPTemplates" name="report_complications_after_delivery.php" forShow="True" url="report_complications_after_delivery.php" comment="//" codePage="utf-8"/>
	</CodeFiles>
	<SecurityGroups>
