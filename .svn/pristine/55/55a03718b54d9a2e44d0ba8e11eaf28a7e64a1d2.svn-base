<?php
//BindEvents Method @1-D06F94DD
function BindEvents()
{
    global $Report_Print;
    global $district_report;
    global $district_report1;
    ...
    $district_report1->Navigator->CCSEvents["BeforeShow"] = "district_report1_Navigator_BeforeShow";
}
...
//district_report1_Navigator_BeforeShow @414-80B08960
function district_report1_Navigator_BeforeShow(& $sender)
{
    $district_report1_Navigator_BeforeShow = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $district_report1; //Compatibility
//End district_report1_Navigator_BeforeShow

//Hide-Show Component @415-286333C6
    $Parameter1 = $Container->TotalPages;
    $Parameter2 = 2;
    if (((is_array($Parameter1) || strlen($Parameter1)) && (is_array($Parameter2) || strlen($Parameter2))) && 0 >  CCCompareValues($Parameter1, $Parameter2, ccsInteger))
        $Component->Visible = false;
...
//Close district_report1_Navigator_BeforeShow @414-E14DE25D
    return $district_report1_Navigator_BeforeShow;
}
//End Close district_report1_Navigator_BeforeShow
