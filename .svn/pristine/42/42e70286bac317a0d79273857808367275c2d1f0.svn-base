	...
	<Components>
		...
		<Report id="3" secured="True" enablePrint="False" showMode="Web" sourceType="Table" returnValueType="Number" linesPerPhysicalPage="50" name="NewBorn27" wizardCaption="{res:CCS_ReportFormPrefix} {res:NewBorn} {res:CCS_ReportFormSuffix}" wizardLayoutType="GroupLeftAbove" connection="registry_db" dataSource="delivery, facilities, newborn" activeCollection="TableParameters">
			...
			<TableParameters>
				...
				<TableParameter id="20" conditionType="Expression" useIsNull="False" field="newborn.DiedID" dataType="Integer" searchConditionType="Equal" parameterType="URL" logicOperator="And" expression="newborn.DiedID=1" parameterSource="DiedID"/>
			</TableParameters>
			<JoinTables>
			...
			<SecurityGroups>
				<Group id="1081" groupID="3" read="True"/>
			</SecurityGroups>
			<Attributes/>
			<Features/>
		</Report>
		<Report id="63" secured="True" enablePrint="False" showMode="Web" sourceType="Table" returnValueType="Number" linesPerPhysicalPage="50" name="NewBorn28" wizardCaption="{res:CCS_ReportFormPrefix} {res:NewBorn} {res:CCS_ReportFormSuffix}" wizardLayoutType="GroupLeftAbove" connection="registry_db" dataSource="delivery, facilities, newborn" activeCollection="TableParameters">
			...
			<TableParameters>
				...
				<TableParameter id="81" conditionType="Expression" useIsNull="False" searchConditionType="Equal" parameterType="URL" logicOperator="And" expression="newborn.DiedID=1"/>
			</TableParameters>
			<JoinTables>
			...
			<SecurityGroups>
				<Group id="1082" groupID="3" read="True"/>
			</SecurityGroups>
			<Attributes/>
			<Features/>
		</Report>
		<Report id="127" secured="True" enablePrint="False" showMode="Web" sourceType="Table" returnValueType="Number" linesPerPhysicalPage="50" name="NewBorn29" wizardCaption="{res:CCS_ReportFormPrefix} {res:NewBorn} {res:CCS_ReportFormSuffix}" wizardLayoutType="GroupLeftAbove" connection="registry_db" dataSource="delivery, facilities, newborn" activeCollection="TableParameters">
			...
			<TableParameters>
				...
				<TableParameter id="146" conditionType="Expression" useIsNull="False" searchConditionType="Equal" parameterType="URL" logicOperator="And" expression="newborn.DiedID=1"/>
			</TableParameters>
			<JoinTables>
			...
			<SecurityGroups>
				<Group id="1083" groupID="3" read="True"/>
			</SecurityGroups>
			<Attributes/>
			<Features/>
		</Report>
		<Report id="191" secured="True" enablePrint="False" showMode="Web" sourceType="Table" returnValueType="Number" linesPerPhysicalPage="50" name="NewBorn30" wizardCaption="{res:CCS_ReportFormPrefix} {res:NewBorn} {res:CCS_ReportFormSuffix}" wizardLayoutType="GroupLeftAbove" connection="registry_db" dataSource="delivery, facilities, newborn" activeCollection="TableParameters">
			...
			<TableParameters>
				...
				<TableParameter id="210" conditionType="Expression" useIsNull="False" searchConditionType="Equal" parameterType="URL" logicOperator="And" expression="newborn.DiedID=1"/>
			</TableParameters>
			<JoinTables>
			...
			<SecurityGroups>
				<Group id="1084" groupID="3" read="True"/>
			</SecurityGroups>
			<Attributes/>
			<Features/>
		</Report>
		<Report id="255" secured="True" enablePrint="False" showMode="Web" sourceType="Table" returnValueType="Number" linesPerPhysicalPage="50" name="NewBorn31" wizardCaption="{res:CCS_ReportFormPrefix} {res:NewBorn} {res:CCS_ReportFormSuffix}" wizardLayoutType="GroupLeftAbove" connection="registry_db" dataSource="delivery, facilities, newborn" activeCollection="TableParameters">
			...
			<TableParameters>
				...
				<TableParameter id="274" conditionType="Expression" useIsNull="False" searchConditionType="Equal" parameterType="URL" logicOperator="And" expression="newborn.DiedID=1"/>
			</TableParameters>
			<JoinTables>
			...
			<SecurityGroups>
				<Group id="1085" groupID="3" read="True"/>
			</SecurityGroups>
			<Attributes/>
			<Features/>
		</Report>
		<Report id="319" secured="True" enablePrint="False" showMode="Web" sourceType="Table" returnValueType="Number" linesPerPhysicalPage="50" name="NewBorn32" wizardCaption="{res:CCS_ReportFormPrefix} {res:NewBorn} {res:CCS_ReportFormSuffix}" wizardLayoutType="GroupLeftAbove" connection="registry_db" dataSource="delivery, facilities, newborn" activeCollection="TableParameters">
			...
			<TableParameters>
				...
				<TableParameter id="338" conditionType="Expression" useIsNull="False" searchConditionType="Equal" parameterType="URL" logicOperator="And" expression="newborn.DiedID=1"/>
			</TableParameters>
			<JoinTables>
			...
			<SecurityGroups>
				<Group id="1086" groupID="3" read="True"/>
			</SecurityGroups>
			<Attributes/>
			<Features/>
		</Report>
		<Report id="383" secured="True" enablePrint="False" showMode="Web" sourceType="Table" returnValueType="Number" linesPerPhysicalPage="50" name="NewBorn33" wizardCaption="{res:CCS_ReportFormPrefix} {res:NewBorn} {res:CCS_ReportFormSuffix}" wizardLayoutType="GroupLeftAbove" connection="registry_db" dataSource="delivery, facilities, newborn" activeCollection="TableParameters">
			...
			<TableParameters>
				...
				<TableParameter id="402" conditionType="Expression" useIsNull="False" searchConditionType="Equal" parameterType="URL" logicOperator="And" expression="newborn.DiedID=1"/>
			</TableParameters>
			<JoinTables>
			...
			<SecurityGroups>
				<Group id="1087" groupID="3" read="True"/>
			</SecurityGroups>
			<Attributes/>
			<Features/>
		</Report>
		<Report id="447" secured="True" enablePrint="False" showMode="Web" sourceType="Table" returnValueType="Number" linesPerPhysicalPage="50" name="NewBorn34" wizardCaption="{res:CCS_ReportFormPrefix} {res:NewBorn} {res:CCS_ReportFormSuffix}" wizardLayoutType="GroupLeftAbove" connection="registry_db" dataSource="delivery, facilities, newborn" activeCollection="TableParameters">
			...
			<TableParameters>
				...
				<TableParameter id="466" conditionType="Expression" useIsNull="False" searchConditionType="Equal" parameterType="URL" logicOperator="And" expression="newborn.DiedID=1"/>
			</TableParameters>
			<JoinTables>
			...
			<SecurityGroups>
				<Group id="1088" groupID="3" read="True"/>
			</SecurityGroups>
			<Attributes/>
			<Features/>
		</Report>
		<Report id="511" secured="True" enablePrint="False" showMode="Web" sourceType="Table" returnValueType="Number" linesPerPhysicalPage="50" name="NewBorn35" wizardCaption="{res:CCS_ReportFormPrefix} {res:NewBorn} {res:CCS_ReportFormSuffix}" wizardLayoutType="GroupLeftAbove" connection="registry_db" dataSource="delivery, facilities, newborn" activeCollection="TableParameters">
			...
			<TableParameters>
				...
				<TableParameter id="529" conditionType="Expression" useIsNull="False" searchConditionType="Equal" parameterType="URL" logicOperator="And" expression="newborn.DiedID=1"/>
			</TableParameters>
			<JoinTables>
			...
			<SecurityGroups>
				<Group id="1089" groupID="3" read="True"/>
			</SecurityGroups>
			<Attributes/>
			<Features/>
		</Report>
		<Report id="542" secured="True" enablePrint="False" showMode="Web" sourceType="Table" returnValueType="Number" linesPerPhysicalPage="50" name="NewBorn36" wizardCaption="{res:CCS_ReportFormPrefix} {res:NewBorn} {res:CCS_ReportFormSuffix}" wizardLayoutType="GroupLeftAbove" connection="registry_db" dataSource="delivery, facilities, newborn" activeCollection="TableParameters">
			<Components>
				<Section id="543" visible="True" lines="0" name="Report_Header" wizardSectionType="ReportHeader" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions">
					<Components>
						<ReportLabel id="544" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Report" name="Report_TotalRecords" function="Count" wizardUseTemplateBlock="False" PathID="NewBorn36Report_HeaderReport_TotalRecords">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
				...
				<Section id="550" visible="True" lines="1" name="Sex_Header" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions">
					<Components>
						<ReportLabel id="551" fieldSourceType="DBColumn" dataType="Integer" html="False" hideDuplicates="False" resetAt="Report" name="GroupSex" PathID="NewBorn36Sex_HeaderGroupSex" fieldSource="Sex">
							<Components/>
							<Events>
								<Event name="BeforeShow" type="Server">
									<Actions>
						...
						<ReportLabel id="553" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Sex" name="CountGroupSex" PathID="NewBorn36Sex_HeaderCountGroupSex" fieldSource="Sex" function="Count">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
			...
			<TableParameters>
				...
				<TableParameter id="559" conditionType="Expression" useIsNull="False" field="newborn.DiedID" dataType="Integer" searchConditionType="Equal" parameterType="URL" logicOperator="And" expression="newborn.DiedID=1" parameterSource="DiedID"/>
				<TableParameter id="1121" conditionType="Parameter" useIsNull="False" field="facilities.FacilityName" dataType="Text" searchConditionType="Equal" parameterType="URL" logicOperator="And" parameterSource="s_FacilityName"/>
</TableParameters>
			<JoinTables>
		...
		<Report id="602" secured="True" enablePrint="False" showMode="Web" sourceType="Table" returnValueType="Number" linesPerPhysicalPage="50" name="NewBorn37" wizardCaption="{res:CCS_ReportFormPrefix} {res:NewBorn} {res:CCS_ReportFormSuffix}" wizardLayoutType="GroupLeftAbove" connection="registry_db" dataSource="delivery, facilities, newborn" activeCollection="TableParameters">
			<Components>
				<Section id="603" visible="True" lines="0" name="Report_Header" wizardSectionType="ReportHeader" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions">
					<Components>
						<ReportLabel id="604" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Report" name="Report_TotalRecords" function="Count" wizardUseTemplateBlock="False" PathID="NewBorn37Report_HeaderReport_TotalRecords">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
				...
				<Section id="610" visible="True" lines="1" name="Sex_Header" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions">
					<Components>
						<ReportLabel id="611" fieldSourceType="DBColumn" dataType="Integer" html="False" hideDuplicates="False" resetAt="Report" name="GroupSex1" PathID="NewBorn37Sex_HeaderGroupSex1" fieldSource="Sex">
							<Components/>
							<Events>
								<Event name="BeforeShow" type="Server">
									<Actions>
						...
						<ReportLabel id="613" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Sex" name="CountGroupSex" PathID="NewBorn37Sex_HeaderCountGroupSex" fieldSource="Sex" function="Count">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
			...
			<TableParameters>
				...
				<TableParameter id="620" conditionType="Expression" useIsNull="False" searchConditionType="Equal" parameterType="URL" logicOperator="And" expression="newborn.DiedID=1"/>
				<TableParameter id="1122" conditionType="Parameter" useIsNull="False" field="facilities.FacilityName" dataType="Text" searchConditionType="Equal" parameterType="URL" logicOperator="And" parameterSource="s_FacilityName"/>
</TableParameters>
			<JoinTables>
		...
		<Report id="666" secured="True" enablePrint="False" showMode="Web" sourceType="Table" returnValueType="Number" linesPerPhysicalPage="50" name="NewBorn38" wizardCaption="{res:CCS_ReportFormPrefix} {res:NewBorn} {res:CCS_ReportFormSuffix}" wizardLayoutType="GroupLeftAbove" connection="registry_db" dataSource="delivery, facilities, newborn" activeCollection="TableParameters">
			<Components>
				<Section id="667" visible="True" lines="0" name="Report_Header" wizardSectionType="ReportHeader" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions">
					<Components>
						<ReportLabel id="668" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Report" name="Report_TotalRecords" function="Count" wizardUseTemplateBlock="False" PathID="NewBorn38Report_HeaderReport_TotalRecords">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
				...
				<Section id="674" visible="True" lines="1" name="Sex_Header" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions">
					<Components>
						<ReportLabel id="675" fieldSourceType="DBColumn" dataType="Integer" html="False" hideDuplicates="False" resetAt="Report" name="GroupSex2" PathID="NewBorn38Sex_HeaderGroupSex2" fieldSource="Sex">
							<Components/>
							<Events>
								<Event name="BeforeShow" type="Server">
									<Actions>
						...
						<ReportLabel id="677" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Sex" name="CountGroupSex" PathID="NewBorn38Sex_HeaderCountGroupSex" fieldSource="Sex" function="Count">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
			...
			<TableParameters>
				...
				<TableParameter id="685" conditionType="Expression" useIsNull="False" searchConditionType="Equal" parameterType="URL" logicOperator="And" expression="newborn.DiedID=1"/>
		...
		<Report id="730" secured="True" enablePrint="False" showMode="Web" sourceType="Table" returnValueType="Number" linesPerPhysicalPage="50" name="NewBorn39" wizardCaption="{res:CCS_ReportFormPrefix} {res:NewBorn} {res:CCS_ReportFormSuffix}" wizardLayoutType="GroupLeftAbove" connection="registry_db" dataSource="delivery, facilities, newborn" activeCollection="TableParameters">
			<Components>
				<Section id="731" visible="True" lines="0" name="Report_Header" wizardSectionType="ReportHeader" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions">
					<Components>
						<ReportLabel id="732" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Report" name="Report_TotalRecords" function="Count" wizardUseTemplateBlock="False" PathID="NewBorn39Report_HeaderReport_TotalRecords">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
				...
				<Section id="738" visible="True" lines="1" name="Sex_Header" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions">
					<Components>
						<ReportLabel id="739" fieldSourceType="DBColumn" dataType="Integer" html="False" hideDuplicates="False" resetAt="Report" name="GroupSex2" PathID="NewBorn39Sex_HeaderGroupSex2" fieldSource="Sex">
							<Components/>
							<Events>
								<Event name="BeforeShow" type="Server">
									<Actions>
						...
						<ReportLabel id="741" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Sex" name="CountGroupSex" PathID="NewBorn39Sex_HeaderCountGroupSex" fieldSource="Sex" function="Count">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
			...
			<TableParameters>
				...
				<TableParameter id="749" conditionType="Expression" useIsNull="False" searchConditionType="Equal" parameterType="URL" logicOperator="And" expression="newborn.DiedID=1"/>
		...
		<Report id="794" secured="True" enablePrint="False" showMode="Web" sourceType="Table" returnValueType="Number" linesPerPhysicalPage="50" name="NewBorn40" wizardCaption="{res:CCS_ReportFormPrefix} {res:NewBorn} {res:CCS_ReportFormSuffix}" wizardLayoutType="GroupLeftAbove" connection="registry_db" dataSource="delivery, facilities, newborn" activeCollection="TableParameters">
			<Components>
				<Section id="795" visible="True" lines="0" name="Report_Header" wizardSectionType="ReportHeader" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions">
					<Components>
						<ReportLabel id="796" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Report" name="Report_TotalRecords" function="Count" wizardUseTemplateBlock="False" PathID="NewBorn40Report_HeaderReport_TotalRecords">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
				...
				<Section id="802" visible="True" lines="1" name="Sex_Header" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions">
					<Components>
						<ReportLabel id="803" fieldSourceType="DBColumn" dataType="Integer" html="False" hideDuplicates="False" resetAt="Report" name="GroupSex2" PathID="NewBorn40Sex_HeaderGroupSex2" fieldSource="Sex">
							<Components/>
							<Events>
								<Event name="BeforeShow" type="Server">
									<Actions>
						...
						<ReportLabel id="805" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Sex" name="CountGroupSex" PathID="NewBorn40Sex_HeaderCountGroupSex" fieldSource="Sex" function="Count">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
			...
			<TableParameters>
				...
				<TableParameter id="813" conditionType="Expression" useIsNull="False" searchConditionType="Equal" parameterType="URL" logicOperator="And" expression="newborn.DiedID=1"/>
		...
		<Report id="858" secured="True" enablePrint="False" showMode="Web" sourceType="Table" returnValueType="Number" linesPerPhysicalPage="50" name="NewBorn41" wizardCaption="{res:CCS_ReportFormPrefix} {res:NewBorn} {res:CCS_ReportFormSuffix}" wizardLayoutType="GroupLeftAbove" connection="registry_db" dataSource="delivery, facilities, newborn" activeCollection="TableParameters">
			<Components>
				<Section id="859" visible="True" lines="0" name="Report_Header" wizardSectionType="ReportHeader" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions">
					<Components>
						<ReportLabel id="860" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Report" name="Report_TotalRecords" function="Count" wizardUseTemplateBlock="False" PathID="NewBorn41Report_HeaderReport_TotalRecords">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
				...
				<Section id="866" visible="True" lines="1" name="Sex_Header" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions">
					<Components>
						<ReportLabel id="867" fieldSourceType="DBColumn" dataType="Integer" html="False" hideDuplicates="False" resetAt="Report" name="GroupSex2" PathID="NewBorn41Sex_HeaderGroupSex2" fieldSource="Sex">
							<Components/>
							<Events>
								<Event name="BeforeShow" type="Server">
									<Actions>
						...
						<ReportLabel id="869" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Sex" name="CountGroupSex" PathID="NewBorn41Sex_HeaderCountGroupSex" fieldSource="Sex" function="Count">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
			...
			<TableParameters>
				...
				<TableParameter id="877" conditionType="Expression" useIsNull="False" searchConditionType="Equal" parameterType="URL" logicOperator="And" expression="newborn.DiedID=1"/>
		...
		<Report id="922" secured="True" enablePrint="False" showMode="Web" sourceType="Table" returnValueType="Number" linesPerPhysicalPage="50" name="NewBorn42" wizardCaption="{res:CCS_ReportFormPrefix} {res:NewBorn} {res:CCS_ReportFormSuffix}" wizardLayoutType="GroupLeftAbove" connection="registry_db" dataSource="delivery, facilities, newborn" activeCollection="TableParameters">
			<Components>
				<Section id="923" visible="True" lines="0" name="Report_Header" wizardSectionType="ReportHeader" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions">
					<Components>
						<ReportLabel id="924" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Report" name="Report_TotalRecords" function="Count" wizardUseTemplateBlock="False" PathID="NewBorn42Report_HeaderReport_TotalRecords">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
				...
				<Section id="930" visible="True" lines="1" name="Sex_Header" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions">
					<Components>
						<ReportLabel id="931" fieldSourceType="DBColumn" dataType="Integer" html="False" hideDuplicates="False" resetAt="Report" name="GroupSex2" PathID="NewBorn42Sex_HeaderGroupSex2" fieldSource="Sex">
							<Components/>
							<Events>
								<Event name="BeforeShow" type="Server">
									<Actions>
						...
						<ReportLabel id="933" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Sex" name="CountGroupSex" PathID="NewBorn42Sex_HeaderCountGroupSex" fieldSource="Sex" function="Count">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
			...
			<TableParameters>
				...
				<TableParameter id="941" conditionType="Expression" useIsNull="False" searchConditionType="Equal" parameterType="URL" logicOperator="And" expression="newborn.DiedID=1"/>
			...
			<SecurityGroups>
				<Group id="1102" groupID="1" read="True"/>
				<Group id="1103" groupID="2" read="True"/>
			</SecurityGroups>
			<Attributes/>
			<Features/>
		</Report>
		<Report id="986" secured="True" enablePrint="False" showMode="Web" sourceType="Table" returnValueType="Number" linesPerPhysicalPage="50" name="NewBorn43" wizardCaption="{res:CCS_ReportFormPrefix} {res:NewBorn} {res:CCS_ReportFormSuffix}" wizardLayoutType="GroupLeftAbove" connection="registry_db" dataSource="delivery, facilities, newborn" activeCollection="TableParameters">
			<Components>
				<Section id="987" visible="True" lines="0" name="Report_Header" wizardSectionType="ReportHeader" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions">
					<Components>
						<ReportLabel id="988" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Report" name="Report_TotalRecords" function="Count" wizardUseTemplateBlock="False" PathID="NewBorn43Report_HeaderReport_TotalRecords">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
				...
				<Section id="994" visible="True" lines="1" name="Sex_Header" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions">
					<Components>
						<ReportLabel id="995" fieldSourceType="DBColumn" dataType="Integer" html="False" hideDuplicates="False" resetAt="Report" name="GroupSex2" PathID="NewBorn43Sex_HeaderGroupSex2" fieldSource="Sex">
							<Components/>
							<Events>
								<Event name="BeforeShow" type="Server">
									<Actions>
						...
						<ReportLabel id="997" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Sex" name="CountGroupSex" PathID="NewBorn43Sex_HeaderCountGroupSex" fieldSource="Sex" function="Count">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
			...
			<TableParameters>
				...
				<TableParameter id="1005" conditionType="Expression" useIsNull="False" searchConditionType="Equal" parameterType="URL" logicOperator="And" expression="newborn.DiedID=1"/>
			...
			<SecurityGroups>
				<Group id="1104" groupID="1" read="True"/>
				<Group id="1105" groupID="2" read="True"/>
			</SecurityGroups>
			<Attributes/>
			<Features/>
		</Report>
		<Report id="1050" secured="True" enablePrint="False" showMode="Web" sourceType="Table" returnValueType="Number" linesPerPhysicalPage="50" name="NewBorn44" wizardCaption="{res:CCS_ReportFormPrefix} {res:NewBorn} {res:CCS_ReportFormSuffix}" wizardLayoutType="GroupLeftAbove" connection="registry_db" dataSource="delivery, facilities, newborn" activeCollection="TableParameters">
			<Components>
				<Section id="1051" visible="True" lines="0" name="Report_Header" wizardSectionType="ReportHeader" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions">
					<Components>
						<ReportLabel id="1052" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Report" name="Report_TotalRecords" function="Count" wizardUseTemplateBlock="False" PathID="NewBorn44Report_HeaderReport_TotalRecords">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
				...
				<Section id="1058" visible="True" lines="1" name="Sex_Header" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions">
					<Components>
						<ReportLabel id="1059" fieldSourceType="DBColumn" dataType="Integer" html="False" hideDuplicates="False" resetAt="Report" name="GroupSex2" PathID="NewBorn44Sex_HeaderGroupSex2" fieldSource="Sex">
							<Components/>
							<Events>
								<Event name="BeforeShow" type="Server">
									<Actions>
						...
						<ReportLabel id="1061" fieldSourceType="DBColumn" dataType="Text" html="False" hideDuplicates="False" resetAt="Sex" name="CountGroupSex" PathID="NewBorn44Sex_HeaderCountGroupSex" fieldSource="Sex" function="Count">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
			...
			<TableParameters>
				...
				<TableParameter id="1068" conditionType="Expression" useIsNull="False" searchConditionType="Equal" parameterType="URL" logicOperator="And" expression="newborn.DiedID=1"/>
...
<Record id="1113" sourceType="Table" urlType="Relative" secured="False" allowInsert="False" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="None" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="delivery_facilities_newbo1" wizardCaption="{res:CCS_SearchFormPrefix} {res:delivery_facilities_newbo} {res:CCS_SearchFormSuffix}" wizardOrientation="Vertical" wizardFormMethod="post" returnPage="report_died_before_labor.ccp" PathID="delivery_facilities_newbo1" pasteActions="pasteActions">
			<Components>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="report_died_before_labor_events.php" forShow="False" comment="//" codePage="utf-8"/>
		<CodeFile id="Code" language="PHPTemplates" name="report_died_before_labor.php" forShow="True" url="report_died_before_labor.php" comment="//" codePage="utf-8"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
