...
//DEL  	
//DEL  	if($NewBorn9->GroupSex->GetValue() == 0)
//DEL  		$NewBorn9->GroupSex->SetValue($CCSLocales->GetText("girl"));
//DEL  	else if($NewBorn9->GroupSex->GetValue() == 1)
//DEL  		$NewBorn9->GroupSex->SetValue($CCSLocales->GetText("boy"));
//DEL  // -------------------------

//Close NewBorn9_GroupSex_BeforeShow @606-3CE3F222

//DEL  // -------------------------
//DEL  global $CCSLocales;
//DEL  	
//DEL  	if($NewBorn10->GroupSex1->GetValue() == 0)
//DEL  		$NewBorn10->GroupSex1->SetValue($CCSLocales->GetText("girl"));
//DEL  	else if($NewBorn10->GroupSex1->GetValue() == 1)
//DEL  		$NewBorn10->GroupSex1->SetValue($CCSLocales->GetText("boy"));
//DEL  // -------------------------

//DEL  // -------------------------
//DEL  global $CCSLocales;
//DEL  	
//DEL  	if($NewBorn11->GroupSex2->GetValue() == 0)
//DEL  		$NewBorn11->GroupSex2->SetValue($CCSLocales->GetText("girl"));
//DEL  	else if($NewBorn11->GroupSex2->GetValue() == 1)
//DEL  		$NewBorn11->GroupSex2->SetValue($CCSLocales->GetText("boy"));
//DEL  // -------------------------

//DEL  // -------------------------
//DEL  global $CCSLocales;
//DEL  	
//DEL  	if($NewBorn12->GroupSex2->GetValue() == 0)
//DEL  		$NewBorn12->GroupSex2->SetValue($CCSLocales->GetText("girl"));
//DEL  	else if($NewBorn12->GroupSex2->GetValue() == 1)
//DEL  		$NewBorn12->GroupSex2->SetValue($CCSLocales->GetText("boy"));
//DEL  // -------------------------

//DEL  // -------------------------
//DEL  global $CCSLocales;
//DEL  	
//DEL  	if($NewBorn13->GroupSex2->GetValue() == 0)
//DEL  		$NewBorn13->GroupSex2->SetValue($CCSLocales->GetText("girl"));
//DEL  	else if($NewBorn13->GroupSex2->GetValue() == 1)
//DEL  		$NewBorn13->GroupSex2->SetValue($CCSLocales->GetText("boy"));
//DEL  // -------------------------

//DEL  // -------------------------
//DEL  global $CCSLocales;
//DEL  	
//DEL  	if($NewBorn14->GroupSex2->GetValue() == 0)
//DEL  		$NewBorn14->GroupSex2->SetValue($CCSLocales->GetText("girl"));
//DEL  	else if($NewBorn14->GroupSex2->GetValue() == 1)
//DEL  		$NewBorn14->GroupSex2->SetValue($CCSLocales->GetText("boy"));
//DEL  // -------------------------

//DEL  // -------------------------
//DEL  global $CCSLocales;
//DEL  	
//DEL  	if($NewBorn15->GroupSex2->GetValue() == 0)
//DEL  		$NewBorn15->GroupSex2->SetValue($CCSLocales->GetText("girl"));
//DEL  	else if($NewBorn15->GroupSex2->GetValue() == 1)
//DEL  		$NewBorn15->GroupSex2->SetValue($CCSLocales->GetText("boy"));
//DEL  // -------------------------

//DEL  // -------------------------
//DEL  global $CCSLocales;
//DEL  	
//DEL  	if($NewBorn16->GroupSex2->GetValue() == 0)
//DEL  		$NewBorn16->GroupSex2->SetValue($CCSLocales->GetText("girl"));
//DEL  	else if($NewBorn16->GroupSex2->GetValue() == 1)
//DEL  		$NewBorn16->GroupSex2->SetValue($CCSLocales->GetText("boy"));
//DEL  // -------------------------

//DEL  // -------------------------
//DEL  global $CCSLocales;
//DEL  	
//DEL  	if($NewBorn17->GroupSex2->GetValue() == 0)
//DEL  		$NewBorn17->GroupSex2->SetValue($CCSLocales->GetText("girl"));
//DEL  	else if($NewBorn17->GroupSex2->GetValue() == 1)
//DEL  		$NewBorn17->GroupSex2->SetValue($CCSLocales->GetText("boy"));
//DEL  // -------------------------

//DEL  // -------------------------
//DEL  global $CCSLocales;
//DEL  	
//DEL  	if($NewBorn18->GroupSex->GetValue() == 0)
//DEL  		$NewBorn18->GroupSex->SetValue($CCSLocales->GetText("girl"));
//DEL  	else if($NewBorn18->GroupSex->GetValue() == 1)
//DEL  		$NewBorn18->GroupSex->SetValue($CCSLocales->GetText("boy"));
//DEL  // -------------------------
...
//DEL  global $CCSLocales;
//DEL  	
//DEL  	if($NewBorn19->GroupSex1->GetValue() == 0)
//DEL  		$NewBorn19->GroupSex1->SetValue($CCSLocales->GetText("girl"));
//DEL  	else if($NewBorn19->GroupSex1->GetValue() == 1)
//DEL  		$NewBorn19->GroupSex1->SetValue($CCSLocales->GetText("boy"));
//DEL  // -------------------------
...
//DEL  global $CCSLocales;
//DEL  	
//DEL  	if($NewBorn20->GroupSex2->GetValue() == 0)
//DEL  		$NewBorn20->GroupSex2->SetValue($CCSLocales->GetText("girl"));
//DEL  	else if($NewBorn20->GroupSex2->GetValue() == 1)
//DEL  		$NewBorn20->GroupSex2->SetValue($CCSLocales->GetText("boy"));
//DEL  // -------------------------
...
//DEL  global $CCSLocales;
//DEL  	
//DEL  	if($NewBorn21->GroupSex2->GetValue() == 0)
//DEL  		$NewBorn21->GroupSex2->SetValue($CCSLocales->GetText("girl"));
//DEL  	else if($NewBorn21->GroupSex2->GetValue() == 1)
//DEL  		$NewBorn21->GroupSex2->SetValue($CCSLocales->GetText("boy"));
//DEL  // -------------------------
...
//DEL  global $CCSLocales;
//DEL  	
//DEL  	if($NewBorn22->GroupSex2->GetValue() == 0)
//DEL  		$NewBorn22->GroupSex2->SetValue($CCSLocales->GetText("girl"));
//DEL  	else if($NewBorn22->GroupSex2->GetValue() == 1)
//DEL  		$NewBorn22->GroupSex2->SetValue($CCSLocales->GetText("boy"));
//DEL  // -------------------------
...
//DEL  global $CCSLocales;
//DEL  	
//DEL  	if($NewBorn23->GroupSex2->GetValue() == 0)
//DEL  		$NewBorn23->GroupSex2->SetValue($CCSLocales->GetText("girl"));
//DEL  	else if($NewBorn23->GroupSex2->GetValue() == 1)
//DEL  		$NewBorn23->GroupSex2->SetValue($CCSLocales->GetText("boy"));
//DEL  // -------------------------
...
//DEL  global $CCSLocales;
//DEL  	
//DEL  	if($NewBorn24->GroupSex2->GetValue() == 0)
//DEL  		$NewBorn24->GroupSex2->SetValue($CCSLocales->GetText("girl"));
//DEL  	else if($NewBorn24->GroupSex2->GetValue() == 1)
//DEL  		$NewBorn24->GroupSex2->SetValue($CCSLocales->GetText("boy"));
//DEL  // -------------------------
...
//DEL  global $CCSLocales;
//DEL  	
//DEL  	if($NewBorn25->GroupSex2->GetValue() == 0)
//DEL  		$NewBorn25->GroupSex2->SetValue($CCSLocales->GetText("girl"));
//DEL  	else if($NewBorn25->GroupSex2->GetValue() == 1)
//DEL  		$NewBorn25->GroupSex2->SetValue($CCSLocales->GetText("boy"));
//DEL  // -------------------------
...
//DEL  global $CCSLocales;
//DEL  	
//DEL  	if($NewBorn26->GroupSex2->GetValue() == 0)
//DEL  		$NewBorn26->GroupSex2->SetValue($CCSLocales->GetText("girl"));
//DEL  	else if($NewBorn26->GroupSex2->GetValue() == 1)
//DEL  		$NewBorn26->GroupSex2->SetValue($CCSLocales->GetText("boy"));
//DEL  // -------------------------
...
//DEL  global $CCSLocales;
//DEL  	
//DEL  	if($NewBorn27->GroupSex->GetValue() == 0)
//DEL  		$NewBorn27->GroupSex->SetValue($CCSLocales->GetText("girl"));
//DEL  	else if($NewBorn27->GroupSex->GetValue() == 1)
//DEL  		$NewBorn27->GroupSex->SetValue($CCSLocales->GetText("boy"));
//DEL  // -------------------------
...
//DEL  global $CCSLocales;
//DEL  	
//DEL  	if($NewBorn28->GroupSex1->GetValue() == 0)
//DEL  		$NewBorn28->GroupSex1->SetValue($CCSLocales->GetText("girl"));
//DEL  	else if($NewBorn28->GroupSex1->GetValue() == 1)
//DEL  		$NewBorn28->GroupSex1->SetValue($CCSLocales->GetText("boy"));
//DEL  // -------------------------
...
//DEL  global $CCSLocales;
//DEL  	
//DEL  	if($NewBorn29->GroupSex2->GetValue() == 0)
//DEL  		$NewBorn29->GroupSex2->SetValue($CCSLocales->GetText("girl"));
//DEL  	else if($NewBorn29->GroupSex2->GetValue() == 1)
//DEL  		$NewBorn29->GroupSex2->SetValue($CCSLocales->GetText("boy"));
//DEL  // -------------------------
...
//DEL  global $CCSLocales;
//DEL  	
//DEL  	if($NewBorn30->GroupSex2->GetValue() == 0)
//DEL  		$NewBorn30->GroupSex2->SetValue($CCSLocales->GetText("girl"));
//DEL  	else if($NewBorn30->GroupSex2->GetValue() == 1)
//DEL  		$NewBorn30->GroupSex2->SetValue($CCSLocales->GetText("boy"));
//DEL  // -------------------------
...
//DEL  global $CCSLocales;
//DEL  	
//DEL  	if($NewBorn31->GroupSex2->GetValue() == 0)
//DEL  		$NewBorn31->GroupSex2->SetValue($CCSLocales->GetText("girl"));
//DEL  	else if($NewBorn31->GroupSex2->GetValue() == 1)
//DEL  		$NewBorn31->GroupSex2->SetValue($CCSLocales->GetText("boy"));
//DEL  // -------------------------
...
//DEL  global $CCSLocales;
//DEL  	
//DEL  	if($NewBorn32->GroupSex2->GetValue() == 0)
//DEL  		$NewBorn32->GroupSex2->SetValue($CCSLocales->GetText("girl"));
//DEL  	else if($NewBorn32->GroupSex2->GetValue() == 1)
//DEL  		$NewBorn32->GroupSex2->SetValue($CCSLocales->GetText("boy"));
//DEL  // -------------------------
...
//DEL  global $CCSLocales;
//DEL  	
//DEL  	if($NewBorn33->GroupSex2->GetValue() == 0)
//DEL  		$NewBorn33->GroupSex2->SetValue($CCSLocales->GetText("girl"));
//DEL  	else if($NewBorn33->GroupSex2->GetValue() == 1)
//DEL  		$NewBorn33->GroupSex2->SetValue($CCSLocales->GetText("boy"));
//DEL  // -------------------------
...
//DEL  global $CCSLocales;
//DEL  	
//DEL  	if($NewBorn34->GroupSex2->GetValue() == 0)
//DEL  		$NewBorn34->GroupSex2->SetValue($CCSLocales->GetText("girl"));
//DEL  	else if($NewBorn34->GroupSex2->GetValue() == 1)
//DEL  		$NewBorn34->GroupSex2->SetValue($CCSLocales->GetText("boy"));
//DEL  // -------------------------
...
//DEL  global $CCSLocales;
//DEL  	
//DEL  	if($NewBorn35->GroupSex2->GetValue() == 0)
//DEL  		$NewBorn35->GroupSex2->SetValue($CCSLocales->GetText("girl"));
//DEL  	else if($NewBorn35->GroupSex2->GetValue() == 1)
//DEL  		$NewBorn35->GroupSex2->SetValue($CCSLocales->GetText("boy"));
//DEL  // -------------------------
