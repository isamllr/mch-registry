<?php
//Include Common Files @1-1BD97D17
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "report_f21_disease_facilities.php");
...
//Operation Method @9-71D9E5CF
    function Operation()
    {
        ...
        $Redirect = "report_f21_disease_facilities.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "report_f21_disease_facilities.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//Class_Initialize Event @528-B3E51FB0
...
//Open Method @528-F7DC8289
    function Open()
    {
        ...
        "AND delivery.FacilityID = (" . $this->SQLValue($this->wp->GetDBValue("1"), ccsInteger) . ")\n" .
        "\n" .
        "\n" .
        "UNION\n" .
        "\n" .
...
//Class_Initialize Event @543-4D967D66
...
//Class_Initialize Event @550-18475CD4
...
//Class_Initialize Event @557-6A01BE8B
...
//Class_Initialize Event @564-3FD09F39
...
//Class_Initialize Event @571-C1A3FDEF
...
//Class_Initialize Event @578-9472DC5D
...
//Class_Initialize Event @585-252E3951
...
//Class_Initialize Event @592-70FF18E3
...
//Class_Initialize Event @599-DE2AE48D
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "report_f21_disease_facilities.html";
$BlockToParse = "main";
...
//Include events file @1-B0F665BD
include_once("./report_f21_disease_facilities_events.php");
...
$Report_Print->Page = "report_f21_disease_facilities.php";
