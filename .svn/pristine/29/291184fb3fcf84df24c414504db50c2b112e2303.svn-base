<?php
//Include Common Files @1-64B0BA82
define("RelativePath", ".");
...
//Class_Initialize Event @103-65D5B6F9
...
//Initialize Method @103-90F4EAD6
    function Initialize()
    {
...
//CheckErrors Method @103-275FF325
...
//DataSource Variables @103-02491101
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @103-13B28C09
...
//Insert Method @103-78FD2555
    function Insert()
    {
        ...
        $this->cp["password"] = new clsSQLParameter("expr122", ccsText, "", "", "{password}", NULL, false, $this->ErrorBlock);
...
//Update Method @103-7654E2B0
    function Update()
    {
        ...
        $wp->AddParameter("1", "sesLoginID", ccsInteger, "", "", CCGetSession("LoginID", NULL), NULL, false);
        if(!$wp->AllParamsSet()) {
...
//Class_Initialize Event @2-2C8C4377
...
//DataSource Variables @2-CE598F82
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-E7D84EBA
...
//Include events file @1-5BB29167
...
//Execute Components @1-A90AA38A
$topmenu->Operations();
$login->Operation();
$employees->Operation();
//End Execute Components

//Go to destination page @1-76B3742F
if($Redirect)
{
