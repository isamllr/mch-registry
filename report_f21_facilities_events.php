...
function BindEvents()
{
    ...
    $Report9->PPP1->CCSEvents["BeforeShow"] = "Report9_PPP1_BeforeShow";
    ...
    $Report23->COUNT_2->CCSEvents["BeforeShow"] = "Report23_COUNT_2_BeforeShow";
...
//Report9_PPP1_BeforeShow @317-CF0459E1
function Report9_PPP1_BeforeShow(& $sender)
{
    $Report9_PPP1_BeforeShow = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $Report9; //Compatibility
//End Report9_PPP1_BeforeShow

//Custom Code @612-2A29BDB7
// -------------------------
    $Report9->PPP1->SetValue(round($Report9->PPP1->GetValue()*100,2));
// -------------------------
//End Custom Code

//Close Report9_PPP1_BeforeShow @317-3FCC301F
    return $Report9_PPP1_BeforeShow;
}
//End Close Report9_PPP1_BeforeShow
...
//Report22_Age_BeforeShow @560-5F19ACD6
...
//Close Report22_Age_BeforeShow @560-6697DA1F
    return $Report22_Age_BeforeShow;
}
//End Close Report22_Age_BeforeShow

//Report22_COUNT_2_BeforeShow @575-75E515E5
...
// -------------------------
   	...
   	if($Report23->Age->GetValue() == 0)
		$Report23->Age->SetText($CCSLocales->GetText("F21RWtested"));
	else if($Report23->Age->GetValue() == 1)
		$Report23->Age->SetText($CCSLocales->GetText("F21Others"));
// -------------------------
//End Custom Code

//Close Report23_Age_BeforeShow @572-89C56CFE
    return $Report23_Age_BeforeShow;
}
//End Close Report23_Age_BeforeShow

//Report23_COUNT_2_BeforeShow @580-7008F003
function Report23_COUNT_2_BeforeShow(& $sender)
{
    $Report23_COUNT_2_BeforeShow = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $Report23; //Compatibility
//End Report23_COUNT_2_BeforeShow

//Custom Code @611-2A29BDB7
// -------------------------
    $Report23->COUNT_2->SetValue(round($Report23->COUNT_2->GetValue()*100,2));
// -------------------------
//End Custom Code

//Close Report23_COUNT_2_BeforeShow @580-80D7480C
    return $Report23_COUNT_2_BeforeShow;
}
//End Close Report23_COUNT_2_BeforeShow
