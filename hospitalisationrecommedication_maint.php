<?php
//Include Common Files @1-EDFD5706
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "hospitalisationrecommedication_maint.php");
...
class clsRecordrecommendedmedicationhospitalisation { //recommendedmedicationhospitalisation Class @2-19861612
...
//Class_Initialize Event @2-18F902B8
    function clsRecordrecommendedmedicationhospitalisation($RelativePath, & $Parent)
    {
        ...
        $this->ErrorBlock = "Record recommendedmedicationhospitalisation/Error";
        ...
        if($this->Visible)
        {
            ...
            $this->DatePicker_DateMedication = new clsDatePicker("DatePicker_DateMedication", "recommendedmedicationhospitalisation", "DateMedication", $this);
...
//Initialize Method @2-907EFC00
    function Initialize()
    {
        ...
        $this->DataSource->Parameters["urlRecommendedMedicationHospitalisationID"] = CCGetFromGet("RecommendedMedicationHospitalisationID", NULL);
    }
...
//Operation Method @2-84613CF1
    function Operation()
    {
        ...
        $Redirect = "hospitalisation_maint.php" . "?" . CCGetQueryString("QueryString", array("ccsForm", "RecommendedMedicationHospitalisationID"));
...
} //End recommendedmedicationhospitalisation Class @2-FCB6E20C

class clsrecommendedmedicationhospitalisationDataSource extends clsDBregistry_db {  //recommendedmedicationhospitalisationDataSource Class @2-7A226659
...
//DataSourceClass_Initialize Event @2-AAA04D8A
...
//Prepare Method @2-C37E3AAF
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "urlRecommendedMedicationHospitalisationID", ccsInteger, "", "", $this->Parameters["urlRecommendedMedicationHospitalisationID"], "", false);
        $this->AllParametersSet = $this->wp->AllParamsSet();
        $this->wp->Criterion[1] = $this->wp->Operation(opEqual, "RecommendedMedicationHospitalisationID", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsInteger),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @2-FAAB43DA
    function Open()
    {
...
//Insert Method @2-E0E65640
    function Insert()
    {
        ...
        $this->SQL = CCBuildInsert("recommendedmedicationhospitalisation", $this->InsertFields, $this);
...
//Update Method @2-9165F350
    function Update()
    {
        ...
        $wp->AddParameter("1", "urlRecommendedMedicationHospitalisationID", ccsInteger, "", "", CCGetFromGet("RecommendedMedicationHospitalisationID", NULL), "", false);
        if(!$wp->AllParamsSet()) {
        ...
        if (!is_null($this->cp["by_user"]->GetValue()) and !strlen($this->cp["by_user"]->GetText()) and !is_bool($this->cp["by_user"]->GetValue())) 
            $this->cp["by_user"]->SetValue($this->CurrentUser->GetValue(true));
        $wp->Criterion[1] = $wp->Operation(opEqual, "RecommendedMedicationHospitalisationID", $wp->GetDBValue("1"), $this->ToSQL($wp->GetDBValue("1"), ccsInteger),false);
        $Where = 
             $wp->Criterion[1];
        ...
        $this->SQL = CCBuildUpdate("recommendedmedicationhospitalisation", $this->UpdateFields, $this);
...
//Delete Method @2-EFB8271A
    function Delete()
    {
        ...
        $Where = 
             $wp->Criterion[1];
        $this->SQL = "DELETE FROM recommendedmedicationhospitalisation";
...
} //End recommendedmedicationhospitalisationDataSource Class @2-FCB6E20C
...
class clsRecordpregnancy_header1 { //pregnancy_header1 Class @92-18A06872

//Variables @92-9E315808
...
//Class_Initialize Event @92-60A6F8D5
...
//CheckErrors Method @92-651F84E8
    function CheckErrors()
    {
        $errors = false;
        $errors = ($errors || $this->PregnancyRecNr->Errors->Count());
...
} //End pregnancy_header1 Class @92-FCB6E20C

class clspregnancy_header1DataSource extends clsDBregistry_db {  //pregnancy_header1DataSource Class @92-FA18A47E

//DataSource Variables @92-E31437D1
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @92-A243E463
...
} //End pregnancy_header1DataSource Class @92-FCB6E20C

//Initialize Page @1-BB75774D
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "hospitalisationrecommedication_maint.html";
$BlockToParse = "main";
...
//Include events file @1-7ED5DFAA
include_once("./hospitalisationrecommedication_maint_events.php");
...
$topmenu->Initialize();
$recommendedmedicationhospitalisation = new clsRecordrecommendedmedicationhospitalisation("", $MainPage);
...
//Execute Components @1-88C5E897
$topmenu->Operations();
$recommendedmedicationhospitalisation->Operation();
$pregnancy_header->Operation();
$pregnancy_header1->Operation();
//End Execute Components

//Go to destination page @1-D039BE36
if($Redirect)
{
