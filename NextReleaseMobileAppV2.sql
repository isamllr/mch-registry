CREATE TABLE `notificationappregistration` (
  ...
  `GCMRegistrationID` varchar(1500) DEFAULT '',
  `PregnancyID` int(10) DEFAULT 0,
  `ActivationCode` varchar(45) DEFAULT '',
...
ALTER TABLE `registry`.`notificationqueue` 
ADD COLUMN `NotificationTypeID` TINYINT(10) NULL AFTER `LatestBy`,
ADD COLUMN `MobileApp` TINYINT(1) NULL AFTER `NotificationTypeID`;

ALTER TABLE `registry`.`notificationqueuehistory` 
ADD COLUMN `NotificationTypeID` TINYINT(10) NULL AFTER `DateTimeSent`,
ADD COLUMN `MobileApp` TINYINT(1) NULL AFTER `NotificationTypeID`;
